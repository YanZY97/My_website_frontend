...
const Contact = () => (
  <div className={globalstyles.contact}>
    ...
    <Tooltip title={<div>好友代码：<Text copyable style={{ color: 'white' }}>162932926 </Text></div>}>
    ...
    <Tooltip title="Douban">
      <IconFont type="icon-douban_F" className={globalstyles.icon} onClick={() => handleClick("https://www.douban.com/people/146301000/")}  />
    </Tooltip>
